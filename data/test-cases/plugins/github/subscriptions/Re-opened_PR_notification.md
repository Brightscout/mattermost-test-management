...
2. Create and close a PR in the subscribed desired repo or in any repo of the subscribed desired organization if not present on Github.
3. Reopen the closed PR on Github and navigate to the subscribed channel or DM/GM on MM.

**Expected**

The user should get the notification regarding the desired PR reopened in the subscribed desired channel or DM/GM on MM. 